...
Getting D3 to connect to mongoDB, after it worked everything else in D3 was fairly easy. Also, converting a csv to JSON I was unable to figure out in the time I had.
...
![screenshot](GDBCheckpoint1.png)

### 2. (5 point)

![screenshot](GDBCheckpoint2.png)

### 3. (5 point)

![screenshot](GDBCheckpoint3.png)
...
![screenshot](MLCheckpoint1.png)

### 2. (5 point)

![screenshot](MLCheckpoint2.png)
